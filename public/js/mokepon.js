...
function seleccionarMokepon(mascotaJugador) {
    fetch(`http://192.168.0.108:8080/mokepon/${jugadorId}`, {
        method: "post",
        headers: {
...
function enviarAtaques() {
    ...
    fetch(`http://192.168.0.108:8080/mokepon/${jugadorId}/ataques`, {
        method: "post",
        headers: {
            "Content-Type": "application/json"
        },
...
function enviarPosicion(x, y) {
    fetch(`http://192.168.0.108:8080/mokepon/${jugadorId}/posicion`, {
        method: "post",
        headers: {
            "Content-Type": "application/json"
        },
